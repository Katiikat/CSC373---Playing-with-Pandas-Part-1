...
print("This should be an apartment with # of beds: 2, # of baths: 2, SQFT: 1487, Purchase: 8.")
print(clf.predict([[2,2,1487,8]]))
print("This should be a condo with # of beds: 1, # of baths: 1, SQFT: 545, Purchase: 9.")
print(clf.predict([[1,1,545,9]]))
